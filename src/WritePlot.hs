...
eb2Filing, eb2Final, eb3Filing, eb3Final :: Bulletin -> [(LocalTime, LocalTime)]
eb2Filing Bulletin{..} = toLineData (Bulletin year month $ filter (\b -> visaDateType b == Filing && visaType b == Just EB2) bulletins)
eb2Final Bulletin{..} = toLineData (Bulletin year month $ filter (\b -> visaDateType b == FinalAction && visaType b == Just EB2) bulletins)
eb3Filing Bulletin{..} = toLineData (Bulletin year month $ filter (\b -> visaDateType b == Filing && visaType b == Just EB3) bulletins)
